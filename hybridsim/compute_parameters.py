...
geo_data_pos2 = np.load(r"C:\Masters\Hybrid\hybridsim\results\pos2\rir_shoebox_pos2_200000_withphase_ismspec.npz")
...
hybrid_data2 = np.load(
    r"C:\Masters\Hybrid\hybridsim\results\pos1\hybrid_rir_avabs.npz",
    allow_pickle=True
)["arr_0"]
...
# ============================================================
print("\nRT60 (Raven) pos 1:")
print(rt60_raven_bands1)

print("\nRT60 (Raven) pos 2:")
print(rt60_raven_bands2)

print("\nRT60 (Raven) pos 3:")
print(rt60_raven_bands3)

print("\nRT60 (Geo) pos 1:")
print(rt60_geo_bands1)

print("\nRT60 (Geo) pos 2:")
print(rt60_geo_bands2)

print("\nRT60 (Geo) pos 3:")
print(rt60_geo_bands3)
...
print(f"RAVEN broadband RT60: {compute_rt60_from_rir(raven_lowpass1, td)}")
print(f"hybrid broadband RT60: {compute_rt60_from_rir(hybrid_data, td)}")
print(f"hybrid avabs broadband RT60: {compute_rt60_from_rir(hybrid_data2, td)}")
